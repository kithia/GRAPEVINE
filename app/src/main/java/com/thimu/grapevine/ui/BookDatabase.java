...
public abstract class BookDatabase extends RoomDatabase {
    ...
    private static class PopulationDbAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            bookDAO.insert(new Book("9780805080018", R.drawable.ic_kenya_square, "Henry Holt", "2005-12-27", "Imperial Reckoning: The Untold Story of Britain's Gulag in Kenya", "Caroline Elkins", "History", "A major work of history that for the first time reveals the violence and terror at the heart of Britain's civilizing mission in Kenya", "English", "475"));
            ...
            bookDAO.insert(new Book("9781406372151", R.drawable.ic_kenya_square, "Walker Books", "2017-04-06", "The Hate U Give", "Angie Thomas", "Crime", "Sixteen-year-old Starr lives in two worlds: the poor neighbourhood where she was born and raised and her posh high school in the suburbs. The uneasy balance between them is shattered when Starr is the only witness to the fatal shooting of her unarmed best friend, Khalil, by a police officer. Now what Starr says could destroy her community. It could also get her killed.\n" +
            ...
            bookDAO.insert(new Book("9780007259762", R.drawable.ic_kenya_square, "HarperCollins Publishers", "2011-05-03", "Holy Bible: King James Version", "Various Authors", "Scripture", "Written in 1611, the KJV is regarded as one of the most accurate translations of the Bible into the English language. The translation is often requested for ceremonial events and given to mark special occasions.", "English", "1152"));
            return null; } }
}
