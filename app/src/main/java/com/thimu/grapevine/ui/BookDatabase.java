...
public abstract class BookDatabase extends RoomDatabase {
    ...
    private static class PopulationDbAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            bookDAO.insert(new Book("9780091906818", R.drawable.bookcover_9780091906818, "Vermilion", "2006-04-06", "How to Win Friends and Influence People", "Dale Carnegie", "Self-Help", "The most famous confidence-boosting book ever published; with sales of over 16 million copies worldwide\n" +
                    "\n" +
            ...
            bookDAO.insert(new Book("9780805080018", R.drawable.bookcover_9780805080018, "Henry Holt", "2005-12-27", "Imperial Reckoning: The Untold Story of Britain's Gulag in Kenya", "Caroline Elkins", "History", "A major work of history that for the first time reveals the violence and terror at the heart of Britain's civilizing mission in Kenya\n" +
                    "\n" +
