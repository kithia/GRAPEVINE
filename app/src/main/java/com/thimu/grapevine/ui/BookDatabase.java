...
public abstract class BookDatabase extends RoomDatabase {
    ...
    private static class PopulationDbAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            bookDAO.insert(new Book("9780007259762", R.drawable.israel_square, "HarperCollins Publishers", "2011-05-03", "Holy Bible: King James Version", "Various Authors", "Religion", "A handsome leather edition of the bestselling King James Version translation. This is a timeless classic and a wonderful gift, prize or keepsake.\n" +
                    "\n" +
